 ...
 * @date 2023/12/14
 */
@WebServlet("/selectGradePlan")
public class SelectGradePlanServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/part2Select.jsp").forward(request,response);
    }
}
